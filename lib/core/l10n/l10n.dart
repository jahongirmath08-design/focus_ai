...
class L10n {
  ...
  String get addHabit =>
      _p("Odat qo'shish", 'Add habit', 'Добавить привычку');
  ...
  String get totalFocusCaps =>
      _p('JAMI DIQQAT', 'TOTAL FOCUS', 'ВСЕГО ФОКУСА');
  ...
  String get replayOnboarding => _p(
      "Tanishtiruvni qayta ko'rish", 'Replay intro', 'Повторить знакомство');
  ...
  String get aboutSub => _p('Focus AI — versiya 1.0', 'Focus AI — version 1.0',
      'Focus AI — версия 1.0');
  ...
  String get onbTagline =>
      _p('Diqqatni nurga aylantir', 'Turn focus into light', 'Преврати фокус в свет');
  ...
  String get onb2Title => _p("Har bir odat — o'z olovi",
      'Each habit — its own flame', 'У каждой привычки — свой огонь');
  ...
  String get onb3Title => _p("Vaqting yo'qolmaydi",
      'Your time is never lost', 'Твоё время не пропадёт');
  ...
  String get habitNameExample => _p(
      "Masalan: Kitob o'qish", 'e.g. Read a book', 'Напр.: Чтение книги');
